...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row col-md-8 col-sm-8 col-md-offset-2"><marquee><h1 class="text-center"><span class="label label-warning">Academic Calender: {!!"$academic->year Semester $academic->semester"!!} in Progress</span></h1></marquee><hr></div>
            <!-- Info boxes -->
      <div class="row">
